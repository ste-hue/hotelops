...
Usage:
    streamlit run dashboard/app_piano_finanziario.py
...
from lib.schemas import PianoFinanziarioInputRow, make_hash, validate_batch
...
def generate_excel(societa: str, anno: int) -> bytes:
    ...
    from actions.genera_piano_finanziario import (
        build_pf_sheet,
        fetch_pf_data,
        fetch_saldo_banca,
        fetch_stagionalita,
