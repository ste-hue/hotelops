...
Usage:
    python -m pipelines.amministrativa.ingest_fornitori
    python -m pipelines.amministrativa.ingest_fornitori --file bq/dimensioni/d_fornitori.csv
    python -m pipelines.amministrativa.ingest_fornitori --dry-run
"""
