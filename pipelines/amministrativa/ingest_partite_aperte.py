...
Usage:
    python -m pipelines.amministrativa.ingest_partite_aperte --file export.xlsx
    python -m pipelines.amministrativa.ingest_partite_aperte --file export.xlsx --societa INTUR
    python -m pipelines.amministrativa.ingest_partite_aperte --file export.xlsx --dry-run
"""
...
from lib.schemas import PartitaApertaFornitoreRow, validate_batch
