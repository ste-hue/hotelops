...
Legge file TXT pipe-delimited da accodamenti/ORTI/,
...
Usage:
    python -m ingest.banca.ingest_accodamenti \\
        --datahub /path/to/datahub --staging /tmp/accodamenti
    python -m ingest.banca.ingest_accodamenti \\
        --datahub /path/to/datahub --staging /tmp/accodamenti --dry-run
    python -m ingest.banca.ingest_accodamenti --inspect /path/to/C_Movimenti.txt
"""
