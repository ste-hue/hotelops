...
from verticals.hub.pages_ import accodamenti, cashflow, cdg, fb, mutui, reviews, spiaggia
...
APPS: list[HubApp] = [
    ...
    HubApp("cdg", "CdG", "📊", "Finanza", "page", cdg.render, "controllo di gestione", sensitive=True),
    # ── Operations ───────────────────────────────────────────────────────────
