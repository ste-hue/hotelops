...
- ~~**Aggiornare dashboard Looker F&B** al nuovo contratto colonne `v_fb_kpi`.~~ **KILL 2026-06-12**: Looker abbandonato per l'F&B — sostituito dalla dashboard Streamlit (spec `2026-06-12-fb-dashboard-streamlit-design.md` approvata, branch `worktree-fb-looker`, hub-ready per `verticals/hub/`).
